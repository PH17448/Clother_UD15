...
public class KhachHangAPI {
    ...
    @GetMapping("/admin/api/tim-kiem-ten-khach-hang-theo-so-dien-thoai")
    public ResponseEntity<String> layHoTenKhachHangTheoSoDienThoai(
    		@RequestParam("soDienThoai") Long soDienThoai) {
    	String hoTen = "";
    	try {
             hoTen = KhachHangService.findFullNameByNumberPhone(soDienThoai);
            return ResponseEntity.ok(hoTen);
        } catch (IllegalArgumentException e) {
