...
$(document).ready(function () {
    ...
    $('#SDTKhachHang').on('change', function () {
    	var sdtKhachHang = $(this).val();
    	if(sdtKhachHang != null){
    		$.get("/admin/api/tim-kiem-ten-khach-hang-theo-so-dien-thoai", {soDienThoai: sdtKhachHang}, function (data) {
    				$('#hoTenKhachHang').val(data);
            });
    	}
    });
